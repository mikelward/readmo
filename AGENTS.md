...
- After pushing, **wait for CI** before claiming a change works in any environment you can't test locally. Don't busy-poll inside the turn — the scheduled PR check under *Autonomy*
